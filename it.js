...
chall.name.tk Fai {0} il turbo uccide {1}
chall.name.drk Fai {0} la deriva uccide {1}
chall.name.kstk Fai a {0} serie di uccisioni {1}
chall.name.w Vinci {0} festa
chall.name.d Muori {0} volte
chall.name.score Fai {0} punto
chall.name.dmg Infliggi {0} quindi io {1}
chall.name.bzk Fai {0} il brusio uccide {1}
chall.name.cc Fai {0} chiudere le chiamate {1}
chall.name.rk Infliggi {0} vendetta {1}
event.doubleXP 2x XP di classe abilitati per questa partita
ranked.join Partecipazione alla partita classificata. L'abbandono di una partita comporterà una squalifica temporanea
ranked.progress partita in corso
ranked.team Please join a Team
ranked.switch Impossibile cambiare durante il gioco
ranked.spectate Osservare disabilitato in classifica
ranked.login Accedi per spawnare
ranked.sync Dati di sincronizzazione mancanti
ranked.team.spawn Per favore, unisciti a una squadra per spawnare
ranked.class.spawn Seleziona una classe da generare
modes.round.win La tua squadra si è assicurata questo round
modes.round.loss Questo round non è più vincibile
modes.round.switch cambiare lato. Preparati per il prossimo round
modes.trade.success Commercio riuscito
modes.prophunt.limit [Prop Hunt] Hai esaurito gli interruttori di prop
modes.prophunt.left [Prop Hunt] Hai {0} interruttori rimanenti
modes.prophunt.rotation.on [Prop Hunt] Rotazione abilitata
modes.prophunt.rotation.off [Prop Hunt] Rotazione disabilitata
modes.prophunt.rotation.reset [Prop Hunt] Ripristino della rotazione.
...
commands.god.on God modalità - Abilitato
commands.god.off God modalità - Disabilitato
commands.god.on.other Modalità Dio - Abilitata per {0}
commands.god.off.other Modalità Dio: disabilitata per {0}
commands.smite.on Punire - Abilitato
commands.smite.off Punire - Disabilitato
commands.smite.on.other Smite - Abilitato per {0}
commands.smite.off.other Smite - Disabilitato per {0}
commands.perk Ha dato {0} {1}
commands.maxperk Ha dato {0} MASSIMO {1}
commands.unlimited.on Munizioni illimitate - Abilitato
commands.unlimited.off Munizioni illimitate - Disabilitato
...
commands.spraybypass.off Munizioni illimitate - Disabilitato
...
commands.suspect.invalid Informazioni sospette non valide
commands.suspect.menu Sospetto nel menu
commands.suspect.left Il sospetto se n'è andato
commands.suspect.found Sospetto trovato. Spettatore: {0}, Generato: {1}, Nome: {2}
commands.forfeit.next Deve giocare almeno 1 round
commands.forfeit.wait Aspetta che la partita inizi a perdere
commands.forfeit.later Si prega di riprovare tra alcuni
commands.forfeit.voted Hai già votato.
commands.forfeit.limit Puoi iniziare solo una votazione per partita
commands.forfeit.ended Gioco perdente
commands.forfeit.ended.other Altra squadra persa
server.message.join {0} si unì al gioco
server.message.left {0} ha abbandonato la partita
server.message.kicked {0} è stato preso a calci
server.message.banned {0} è stato bandito
server.message.votekicked {0} è stato votato a calci
server.message.arrested {0} è stato arrestato dal KPD
`;
