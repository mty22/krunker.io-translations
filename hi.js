...
menu.btn.host होस्ट खेल
menu.btn.browser सर्वर
...
generic.matchover मैच ओवर
generic.matchaband मैच छोड़ दिया
generic.follow फॉलो
generic.unfollow अनफॉलो
generic.followers अनुयायी
generic.following निम्नलिखित
generic.games खेल
generic.wins जीत
generic.lose घाटा
generic.clan क्लैन
...
generic.logout.sessions सभी सत्रों का लॉगआउट
generic.username उपयोगकर्ता नाम
...
settings.controls.press किसी भी कुंजी को दबाएं
...
settings.dev.extraBan अतिरिक्त प्रतिबंध जानकारी
settings.chat.header चैट
settings.chat.chat चैट बॉक्स दिखाएँ
settings.chat.chat.all हमेशा
settings.chat.chat.focus ध्यान केंद्रित करते हुए
settings.chat.messages प्लेयर संदेश दिखाएँ
settings.chat.unboxings शो Unboxings
settings.chat.chatOp चैट अपारदर्शिता
settings.chat.chatBGOp चैट बीजी अस्पष्टता
settings.chat.chatHeight चैट ऊंचाई
settings.chat.chatTimer चैट टाइमर (s)
settings.chat.chatTextOutline चैट पाठ रूपरेखा
settings.chat.chatFilter गालियां बकने की क्रिया फ़िल्टर
settings.quality.header प्रदर्शन
settings.quality.updRate फ़्रेम कैप
settings.quality.rendDst रेंडर दूरी
settings.quality.res संकल्प
settings.quality.part कण
settings.quality.mapDet मानचित्र विवरण
settings.quality.noTex कोई बनावट नहीं
settings.quality.partdist कण दूरी
settings.quality.renderdist रेंडर दूरी
settings.quality.reflection प्रतिबिंब गुणवत्ता
settings.quality.antiAlias एंटीअलियासिंग
settings.quality.shadows छाया
settings.quality.softShad नरम छाया
settings.quality.highResShad उच्च Res छाया
settings.quality.shadowsDynamic गतिशील छाया
settings.quality.trails बुलेट ट्रेल्स
settings.quality.yourTrails अपने ट्रेल्स
settings.quality.mflash थूथन फ्लैश
settings.quality.flap निशानची प्रालंब
settings.quality.lowSpec कम कल्पना
settings.quality.ambient परिवेश छायांकन
settings.quality.ambientOld पुरानी छायांकन (जब संभव हो)
settings.quality.textureAnim बनावट एनिमेशन
settings.quality.objectAnim वस्तु एनिमेशन
settings.quality.screenShake स्क्रीन शेक
settings.quality.weaponShine हथियार चमकते
settings.quality.rendGamma गामा
settings.quality.lighting प्रकाश
settings.quality.showExplo विस्फोट दिखाएँ
settings.quality.aspectRatio पहलू अनुपात
...
settings.post.bloomRadius ब्लूम त्रिज्या
settings.post.ssao SSAO
settings.post.ssaoRadius SSAO त्रिज्या
settings.interface.hitInd हिट संकेतक दिखाएं
settings.interface.hitColor हिट सूचक रंग
settings.interface.dmg क्षति दिखाएँ
settings.interface.dmgCol नुकसान का रंग
settings.interface.critCol Crit रंग
settings.interface.header इंटरफ़ेस
settings.interface.scale यूआई स्केल
settings.interface.ui यूआई दिखाएँ
...
settings.interface.speed आंदोलन की गति दिखाएं
settings.interface.speedOffX स्पीड एक्स ऑफसेट
settings.interface.speedOffY स्पीड वाई ऑफसेट
settings.interface.speedOpacity गति अस्पष्टता
settings.interface.speedScale स्पीड स्केल
settings.interface.speedColor गति रंग (वर्तमान)
settings.interface.speedColorMax गति रंग (अधिकतम)
settings.interface.medals पदक दिखाएं
settings.interface.hideNames Nametag प्रदर्शन
settings.interface.hideNames.team टीम केवल
settings.interface.hideNames.enemy केवल दुश्मन
settings.interface.hideNames.all हर कोई
settings.interface.nametagStyle Nametag शैली
settings.interface.nametagOpac Nametag अस्पष्टता
settings.interface.nametagStyle.health केवल स्वास्थ्य
settings.interface.nametagStyle.name केवल नाम
settings.interface.nametagStyle.nameLvl केवल नाम और स्तर
settings.interface.nametagStyle.all सब कुछ
settings.interface.healthNum Nametag स्वास्थ्य संख्या
settings.interface.healthColT Nametag स्वास्थ्य टीम के रंग
settings.interface.healthColE Nametag स्वास्थ्य रंग दुश्मन
settings.interface.xpBarCol XP पट्टी रंग
settings.interface.xpBarOpac XP बार अस्पष्टता
settings.crosshair.header Crosshair
settings.crosshair.type टाइप करें
settings.crosshair.type.2 कस्टम
settings.crosshair.type.3 स्तरित
settings.crosshair.type.4 छवि
settings.crosshair.type.5 परिशुद्धता
settings.crosshair.style शैली
settings.crosshair.style.0 क्रॉस
settings.crosshair.style.1 खोखले सर्कल
settings.crosshair.style.2 ठोस चक्र
settings.crosshair.style.3 खोखले वर्ग
settings.crosshair.style.4 ठोस वर्ग
settings.crosshair.image छवि
settings.crosshair.image.paste Crosshair छवि
...
settings.crosshair.size आकार
settings.crosshair.thickness मोटाई
settings.crosshair.gap गैप
settings.crosshair.dot डॉट
settings.crosshair.opacity.use कस्टम अस्पष्टता का उपयोग करें
settings.crosshair.opacity.custom कस्टम अस्पष्टता
settings.hitmarker.header Hitmarker
settings.hitmarker.color रंग
settings.hitmarker.kcolor रंग को मार डालो
settings.hitmarker.thickness मोटापा
settings.hitmarker.opacity अस्पष्टता
settings.hitmarker.leng लम्बाई
settings.hitmarker.spacing अंतर
settings.hitmarker.animD एनीमेशन का आकार
settings.hitmarker.animS एनिमेशन का गति
settings.hitmarker.hitm दिखाओ
settings.hitmarker.hitmFad फेड गति
settings.hitmarker.custom हिटमार्केर इमेज
settings.hitmarker.custom.paste हिटमार्केर इमेज यूआरएल
settings.onKillS.style.0 चूक
settings.onKillS.style.1 कम संकल्प
...
settings.audio.skin काज़्मेटिक वॉल्यूम
settings.audio.ui यू.आय. वॉल्यूम
...
windows.loadout.color.skin स्किन रंग
windows.loadout.color.chat बातचीत नाम रंग
windows.loadout.color.hair बाल रंग
...
windows.controls.confirm कन्फर्म इंटरैक्ट
...
windows.host.settings सर्वर समायोजन
windows.host.preset मेज़बान प्रीसेट
...
windows.publish.map.paste खेल डेटा चिपकाएँ
...
windows.store.premium प्रीमियम ख़रीदये
windows.store.premium2 क्रंकर प्रीमियम
windows.store.buyP प्रदर्शित होने वाला नाम और अधिक चुनें
...
windows.reticle.req अपेक्षित स्तर {0}
windows.dye.header डाई चुने 
windows.dye.default बकाया डाई 
windows.dye.spin डाई
windows.changelog.header बदलाव
windows.mods.community.header समुदाय मोड्स 
windows.mods.community.fav आपके पसंदीदा
windows.mods.community.new नए मोड्स 
windows.mods.community.hot हॉट 
windows.mods.community.name मोड़ का नाम
windows.mods.community.none कोई मोड़ नहीं मिला
...
windows.secondary.unlocked अनलॉक्ड
windows.secondary.req Req स्तर  {0}
windows.advertise.header विज्ञापित
windows.support.header सप्पोर्ट 
...
custom.mode.missing कम से कम एक मोड चुने
custom.class.missing कम से कम एक क्लास चुने
server.config.maxPlayers खिलाडी
...
server.config.strafeSpd स्ट्रॉफी गति
server.config.fiRat फायर रेट
server.config.reSpd रीलोड करने की गति
server.config.slidTime फिसलने का समय
server.config.fixMov फिक्स्ड मूवमेंट
server.config.slidSpd फिसलने की गति
server.config.healthMlt स्वास्थ्य गुणक
server.config.impulseMlt हथियार आवेग
...
server.config.t1Dmg दल 1 चोट
server.config.t2Dmg दल 2 चोट
server.config.t3Dmg दल 3 चोट
server.config.t4Dmg दल 4 चोट
server.config.t5Dmg दल 5 चोट
...
server.config.noSecondary सेकंडरिस अक्षम
server.config.noStreaks धारियाँ अक्षम
server.config.canSlide फिसलना
server.config.wallJP दीवार कूदने की शक्ति
server.config.autoJump स्वतः कूदना
server.config.bDrop गोली का पात
server.config.thirdPerson थर्ड पर्सन
server.config.requireCaptcha कॅप्टचा की आवश्यकता
...
server.config.forceC दल का स्कोर रखे
server.config.logTim समय का पता (दौड़,पारकोर)
server.config.hitBoxPad हिटबॉक्स पैडिंग
server.config.hpRegen स्वास्थ्य पुनर्जनन	
server.config.disableB सीमाए अक्षम करे
...
social.market.price.low निम्रतम मूल्य
social.market.price.list बेचने की कीमत
social.market.searching ढूंढ रहे है
...
social.market.req पद {0} अर्जित हो गया
social.market.cant खरीदने मई समर्थ नहीं है
social.market.purchase खरीदो
social.market.fee बेचने के लिए कोई शुल्क नहीं है
social.market.failed विफल हुए. पुनः प्रयत्न करे
social.market.head टोपी की आइटम
social.market.back टोपी की आइटम
social.market.waist कमर की आइटम
social.market.face कमर की आइटम
