...
leaderboard.empty Tyhjä Aula
popup.checkpoint Tallennuspiste!
app.play PAINA PELATAKSESI
app.spectate PAINA KATSOAKSESI
app.play.mobile NAPAUTA PELATAKSESI
app.spectate.mobile NAPAUTA KATSOAKSESI
app.play.controller PAINA ALOITTAAKSESI
app.spectate.controller Paina START Katsoaksesi
...
settings.chat.header Keskustelualue
settings.chat.chat Näytä Keskustelualue
settings.chat.chat.all Aina
settings.chat.chat.focus While Focused
settings.chat.messages Näytä pelaajien viestit
settings.chat.unboxings Näytä laatikkojen avaukset
settings.chat.chatOp Keskustelualueen läpinäkyvyys
settings.chat.chatBGOp Keskustelualueen taustan läpinäkyvyys
settings.chat.chatHeight Keskustelualueen korkeus
settings.chat.chatTimer Keskustelualueen Ajastin
settings.chat.chatTextOutline Keskustelualueen ääriviivat
settings.chat.chatFilter Kirosanasuodatin
settings.quality.header Suorituskyky
settings.quality.updRate Maksimi kuvataajuus
...
settings.quality.weaponShine Aseen Kiitlo
...
settings.interface.hitInd Näytä Osumien Indikaattorit
settings.interface.hitColor Osuman Indikaattorin Väri
...
settings.interface.spectators Näytä Katsojat
settings.interface.speed Näytä Liikkumisnopeus
settings.interface.speedOffX Nopeuslaskurin X Etäisyys
settings.interface.speedOffY Nopeuslaskurin Y Etäisyys
...
settings.interface.healthNum Nimimerkin Terveys
...
settings.crosshair.type.5 Tarkkuus
...
settings.hitmarker.spacing Riviväli
...
settings.hitmarker.custom.paste Osuman Image URL
...
settings.controller.sensitivityX X Herkkyys
settings.controller.disableCons Poista Ohjaimet Pois Käytöstä
settings.controller.sensitivityY Y Herkkyys
settings.controller.aimsensX Tähtäyksen X Herkkyys
settings.controller.aimsensY Tähtäyksen Y Herkkyys
...
settings.controller.invert Käännä Y-Akseli
settings.mobile.header Mobiili
settings.mobile.sensitivityX X Herkkyys
settings.mobile.sensitivityY Y Herkkyys
settings.mobile.aimsensX Tähtäyksen X Herkkyys
settings.mobile.aimsensY Tähtäyksen Y Herkkyys
settings.mobile.vibration Tärinä
settings.mobile.gradSpeed Asteittainen Nopeus
settings.mobile.invert Käännä Y-Akseli
...
settings.viewmodel.xOff Aseen X-Akseli
settings.viewmodel.yOff Aseen Y-Akseli
settings.viewmodel.zOff Aseen Z-Akseli
...
settings.mods.streak Tappoputkilaskinkuvakkeen Kuva
settings.mods.streak.paste Tappoputkilaskinkuvakkeen Kuvan URL
...
windows.loadout.color.chat Chatin Pelinimen Väri
...
windows.store.market2 Krunker-marketti
...
windows.client.windows Windows-Asennus
windows.client.mac macOS-Asennus
windows.client.linux Linux-Asennus
...
social.since Since
social.user.maps Käyttäjäpelit
social.user.mods Käyttäjämodit
social.maps.none Pelejä Ei Löydetty...
social.mods.none Modeja Ei Löydetty...
social.market.price.low Alin Hinta
social.market.price.list Listaa Hinta
social.market.searching Etsitään
social.market.listed listattu {0} sitten
social.market.list Listaa Esine
social.market.unlist Poista Listaus
social.market.unlisting Poistetaan Listausta...
...
social.market.fee Ei Listausmaksua
...
social.trading.submitting Tarjousta Tarjotaan...
