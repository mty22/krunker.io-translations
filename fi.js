...
app.play.controller PAINA START ALOITTAAKSESI
...
settings.quality.rendDst Renderöintietöisyys
...
settings.interface.nametagStyle.health Ainoastaan HP-pisteet
...
settings.mobile.sensitivityX Herkkyys Y
...
settings.audio.mic Mikrofonin Ääni
...
settings.editing.scoreOffX Popup-Pisteiden Sijainti X
settings.editing.scoreOffY Popup-Pisteiden Sijainti Y
...
settings.editing.progm.color Latauspalkin Väri
settings.editing.progmo.color Ylilatautumisen Väri
settings.editing.progm.opacity Latauspalkin Läpinäkyvyys
...
matchmaker.NoAvailableServers Serverit ovat maksumikapasiteetilla
...
server.config.reSpd Aseen Lataamisen Nopeus Nopeus
...
server.config.hitBoxPad Osumalaatikon Pehmennys
server.config.hpRegen HP-Pisteiden Regenerointi
...
social.market.collectible Keräilyesine
...
social.trading.submitting Lähetetään Tarjousta...
...
custom.host.ranked Et voi luoda peliä ollessasi kilpailullisessa pelissä
...
item.sell.destroy Haluatko varmasti tuhota {0}?
