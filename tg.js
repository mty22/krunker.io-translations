...
settings.quality.trails Mga Daan ng Bala
settings.quality.yourTrails Daan ng Inyong Bala
...
settings.post.bloomThreshold Pagningning ng Threshold
settings.post.bloomStrength Lakas ng Pagningning
...
settings.crosshair.shadow.thickness Kapal ng Anino
settings.crosshair.size Sukat
settings.crosshair.thickness Kapal
...
settings.hitmarker.thickness Kulay
settings.hitmarker.opacity Opacity
settings.hitmarker.leng Haba
settings.hitmarker.spacing Pag-ispace ng Hitmarker
settings.hitmarker.animD Laki ng Animasyon 
settings.hitmarker.animS Bilis ng Animasyon
settings.hitmarker.hitm Ipakita ang Hitmarker
settings.hitmarker.hitmFad Bilis ng Pagkupas
settings.hitmarker.custom Larawan ng Hitmarker
settings.hitmarker.custom.paste URL ng Hitmarker Image URL
settings.onKillS.style.0 Default
settings.onKillS.style.1 Bawasan ang Resolusyon
settings.onKillS.style.2 Bawasan ang FOV
settings.onKillS.style.3 Taasan ang FOV
...
settings.controller.disableCons Huwag paganahin ang Mga Controller
...
settings.mobile.vibration Panginginig ng boses
settings.mobile.gradSpeed Unti-unting Bilis (?)
...
settings.mods.scope Larawan ng Scope
settings.mods.scope.paste URL ng Imahe ng Scope
settings.mods.scope.opacity Opacity ng Scope
settings.mods.scope.width Saklaw ng Scope
settings.mods.scope.height Tangkad ng Scope
settings.mods.dot Imahe ng Reticle (retikulo)
settings.mods.dot.width Lawak ng Imahe ng Reticle (retikulo)
settings.mods.dot.height Tangkad ng Imahe ng Reticle (retikulo)
settings.mods.dot.paste URL ng Reticle (retikulo)
settings.mods.endmessage Mensaheng Pagtatapos 
settings.mods.profile Larawan ng Profile
settings.mods.profile.paste I-paste ang URL ng Imahe ng Profile
settings.mods.ammo Larawan ng Bala
...
settings.mods.damage Larawan ng Overlay sa Pinsala o Damage
...
windows.maps.publish I-publish at I-akda ang Laro
windows.maps.community Komunidad ng Devs
