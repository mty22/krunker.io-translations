...
settings.editing.menuHue 色調 （使用者介面） 
...
settings.mods.load 載入外掛程式
settings.mods.logo 允許變更圖示
settings.mods.auto 自動載入外掛程式
...
windows.mods.drop 將外掛程式檔放在此處/按一下 
windows.mods.paste 粘貼外掛程式網址 
windows.mods.load 載入外掛程式
windows.mods.none 沒有找到外掛程式
windows.mods.header 外掛程式管理員 
windows.mods.guide 外掛程式指南 
windows.mods.list 外掛程式清單 
windows.mods.load.header 載入外掛程式
windows.mods.publish 發佈外掛程式
...
windows.mods.community.header 社區外掛程式
windows.mods.community.fav 最愛 
windows.mods.community.new 最新外掛程式
windows.mods.community.hot 最熱門 
windows.mods.community.name 外掛程式名稱 
windows.mods.community.none 沒有找到外掛程式
windows.publish.mod.header 發表外掛程式
windows.publish.mod.thumbnail 沒有縮略圖 
windows.publish.mod.name 外掛程式名稱 
windows.publish.mod.paste 外掛程式網址 
...
mod.disabled 外掛程式已關閉 
mod.error 外掛程式錯誤！ 
mod.loading 載入外掛程式中... 
mod.invalid 無效外掛程式檔案！ 
matchmaker.full 滿 
...
error.extentions 如果您有任何（瀏覽器）外掛程式， 請關閉它們
...
social.user.mods 使用者外掛程式 
social.maps.none 找不到遊戲... 
social.mods.none 找不到外掛程式... 
