...
menu.btn.maps Mapid
menu.btn.mods Modid
menu.btn.settings Seaded
menu.btn.customize Muuda
menu.btn.invite Kutsu
menu.btn.invite.clicked Link kopeeritud
menu.btn.join Liitu
  menu.btn.host Pea mängu.
menu.btn.browser Serveri browser
generic.wait Oota...
generic.loading Laadib...
generic.none Mitte midagi
generic.connecting Ühendab...
generic.select Vali
generic.delete Kustuta
generic.save Salvesta
generic.load Lae
generic.search Otsi
generic.leave Lahku
generic.default Tavaline
generic.submit Saada
generic.create Loo
generic.random Suvaline
generic.failed Ebaõnnestus
generic.success Õnnestus
generic.name Nimi
generic.level Level
generic.score Skoor
generic.off Otsas
generic.defeat KAOTUS
generic.victory VÕIT
generic.matchover MÄNG LÄBI
generic.matchaband MÄNG TÜHISTATUD
generic.follow Follow
generic.unfollow Unfollow
generic.followers Follower
generic.following folgt
generic.games Mängud
generic.wins Võidud
generic.lose Kaotused
generic.clan Clan
generic.games.played Mängitud mängud
generic.games.won Võidetud mängud
generic.games.lost Kaotatud mängud
generic.timep Mänguaeg
generic.kills Tapmised
generic.deaths Surmad
generic.kdr KDR
generic.time Aeg
generic.logout Logi välja
generic.logout.sessions Logi kõikidest sessionidest välja
generic.username Kasutajanimi
generic.password Parool
generic.register Registreeri
generic.login Logi sisse
generic.accuracy Täpsus
player.waiting Ootame mängijaid
player.died Sa surid
player.killed sind tappis 
player.killstreak {0} on {1} killstreakil
player.inactive Mitteaktiivsuse tõttu eemaldatud
player.disconnect ÜHENDUS KATKES
