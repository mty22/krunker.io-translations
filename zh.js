...
generic.games.won 胜场 
generic.games.lost 败场 
generic.timep 游玩时间 
generic.kills 击杀 
generic.deaths 死亡 
generic.kdr 杀死率 
generic.time 时间 
generic.logout 注销 
generic.logout.sessions 从所有设备注销 
...
player.inactive 已断开连接因不在线 
player.disconnect 已断开连接 
timer.end 下一场将在 {0} 后开始 
leaderboard.empty 空房间 
popup.checkpoint 记录点! 
app.play 点击以开始游戏 
app.spectate 观察赛场 
app.play.mobile 触摸以开始游戏 
app.spectate.mobile 触摸以观察赛场 
app.play.controller 按下开始键以开始游戏 
app.spectate.controller 按下开始键以观察赛场 
purchase.error 出现错误 
purchase.error.click 点此 </a> 以重试! 
purchase.error.limit 您已超出每日交易限额 
settings.reset 重置 
settings.reset.confirm 您是否希望重置所有设置? 
settings.import 导入 
settings.export 导出 
settings.none 没有找到此设置 
settings.backup 备份设置 
settings.controls.change 键钮绑定 
...
settings.popup.freeKRPop 显示免费KR弹窗 
settings.experimental.header 实验性功能 
settings.experimental.aimFreezeFix 瞄射冻结修复 
settings.experimental.mouseFlickFix 鼠标抽动修复 
settings.experimental.shaderRendering 实例渲染
settings.dev.header 开发者 
settings.dev.forceUpdate 强制更新皮肤 
settings.dev.forceRegen 永再生玩家 
settings.dev.extraBan 额外禁令信息 
...
settings.quality.flap 瞄准镜保护盖 (只限狙击步枪) 
settings.quality.lowSpec 低配置模式 
settings.quality.ambient 环境阴影 
settings.quality.ambientOld 老阴影 (如果可能)
...
settings.quality.rendGamma 伽马
settings.quality.lighting 光照效果 
settings.quality.showExplo 显示爆炸效果
settings.quality.aspectRatio 屏幕高宽比 
settings.post.header 前期处理
settings.post.post 后期处理
settings.post.bloom 绽放
settings.post.bloomThreshold 绽放阈值
settings.post.bloomStrength 绽放强度
settings.post.bloomRadius 绽放半径
settings.post.ssao SSAO
settings.post.ssaoRadius SSAO 半径
...
settings.interface.showTradeMsg 显示物品交易信息
...
settings.interface.deaths 显示死亡计数器
settings.interface.kd 显示杀/死数
...
settings.crosshair.style.3 空心方 
settings.crosshair.style.4 实心方 
...
settings.controller.aimsensX 瞄准(ADS)X轴灵敏度 
settings.controller.aimsensY 瞄准(ADS)Y轴灵敏度 
...
settings.mobile.aimsensX 瞄准(ADS)X轴灵敏度 
settings.mobile.aimsensY 瞄准(ADS)Y轴灵敏度 
...
settings.audio.dialogue 行动音量
settings.viewmodel.header 视角 
settings.viewmodel.fov 视野 
settings.viewmodel.fps 武器渲染视野 
...
settings.viewmodel.roundArms 圆手臂
settings.viewmodel.show.melee 显示近战武器 
settings.viewmodel.show.ads 瞄准 (ADS) 时隐藏武器 
settings.viewmodel.toggleAim 切换目标
settings.viewmodel.show.hands 显示手部 
settings.viewmodel.leftHand 左手模式 
settings.viewmodel.aimAnim 武器瞄准(ADS)动画 
settings.viewmodel.rot 武器旋转 
settings.viewmodel.xOff 武器X轴坐标 
settings.viewmodel.yOff 武器Y轴坐标 
settings.viewmodel.zOff 武器Z轴坐标 
settings.viewmodel.weapSwapY 武器交换Y轴
settings.viewmodel.weapReloadY 武器换弹Y轴
settings.viewmodel.yOffADS 武器瞄准 (ADS) Y轴坐标 
settings.viewmodel.adsFovMlt 瞄准 (ADS) 视野倍率 
...
settings.editing.progOffX 进度条X轴
settings.editing.progOffY进度条Y轴 
settings.editing.progRot 进度条旋转
settings.editing.progm.color 充进度条颜色
settings.editing.progm.opacity 充进度条透明度
settings.editing.progm.scale 充进度条秤
settings.editing.progm.shadow 充进度条阴影
settings.editing.progmOffX 充进度条X轴
settings.editing.progmOffY 充进度条Y轴
settings.editing.progmRot 充进度条旋转
settings.editing.saturation 颜色饱和度 (游戏中) 
settings.editing.menuSaturation 颜色饱和度 (用户界面) 
...
settings.editing.tracer.offset 示踪轨迹 
settings.shaders.header 着色器输入 
settings.mods.header 自定义 
settings.mods.load 允许加载插件 
settings.mods.logo 允许变更游戏商标 
settings.mods.auto 自动加载插件 
settings.mods.borders 瞄准镜边界 
settings.mods.borderCol 瞄准镜边界 
settings.mods.borderOpac 瞄准镜边界透明度
settings.mods.scope 瞄准镜图标 
settings.mods.scope.paste 瞄准镜图标网址 
settings.mods.scope.opacity 瞄准镜透明度
settings.mods.scope.width 瞄准镜图像宽度
settings.mods.scope.height 瞄准镜图像高度
...
windows.servers.online {0} 人在游戏中 
windows.servers.social {0} 在社交中 
...
windows.loadout.primary.scope 瞄准镜
...
windows.loadout.shoe 鞋
windows.loadout.face 脸部 
windows.loadout.spray 涂鸦 
windows.loadout.color.skin 皮肤颜色 
windows.loadout.color.chat 聊天名颜色 
...
windows.mods.drop 将插件文件放在此处/单击 
windows.mods.paste 粘贴插件网址 
windows.mods.load 加载插件 
windows.mods.none 没有找到插件 
windows.mods.header 插件管理器 
windows.mods.guide 插件指南 
windows.mods.list 插件列表 
windows.mods.load.header 加载插件 
windows.mods.publish 发布插件 
windows.mods.viewer 观看者 
windows.account.header 帐户 
windows.account.recover 联系 <a>krunker@yendis.ch</a> 找回密码 
...
windows.controls.reset 重置位置 (比赛 & 跑酷)
...
windows.store.premium 购买高级会员 
windows.store.premium2 Krunker 高级会员 
windows.store.buyP 选择显示名称以及更多内容 
windows.store.buy 购买物品 
windows.store.wheels 奖轮 
windows.store.unlock 解锁新武器和物品 
windows.store.amount 你有 {0} KR 剩余 
...
windows.premium.header 高级会员
windows.skin.header 选择皮肤 
windows.hat.header 选择帽子 
windows.back.header 选择背部饰品 
windows.waist.header 选择腰部饰品 
windows.face.header 选择面部饰品 
windows.melee.header 选择近战武器 
windows.attach.header 选择附件 
windows.reticle.header 选择准星 
windows.reticle.unlocked 于 {0} 等级结束 
windows.reticle.req 需要 {0} 等级 
windows.dye.header 选择服装 
windows.dye.default 默认服装 
windows.dye.spin 服装 
windows.changelog.header 变更日志 
windows.mods.community.header 社区插件
windows.mods.community.fav 已收藏插件 
windows.mods.community.new 最新插件 
windows.mods.community.hot 热门插件 
windows.mods.community.name 插件名称 
windows.mods.community.none 没有找到此插件 
windows.publish.mod.header 发表插件 
windows.publish.mod.thumbnail 没有缩略图 
windows.publish.mod.name 插件名称 
windows.publish.mod.paste 插件网址 
windows.publish.mod.update 发表/更新 
windows.publish.mod.login 以创建并上传插件! 
windows.secondary.header 选择次要武器 
windows.secondary.unlocked 已解锁 
windows.secondary.req 需要至少 {0} 等级 
...
windows.join.code 输入游戏网址/代码 
windows.client.header 客户端 
windows.client.windows Windows 游戏安装器 
windows.client.mac MacOS 游戏安装器 
windows.client.linux Linux 游戏安装器 
windows.ranked.header 排位赛 
windows.ranked.login 以进行排位赛! 
windows.ranked.level 您至少需要 <span color="black"> {0} 级</span> 以进行排位赛! 当前您的等级是 <span color="black"> {1} 级</span>. 
windows.ranked.mode.r1v1 单挑 
windows.ranked.mode.r2v2 双挑 
windows.ranked.mode.r4v4 四挑 
windows.chall.header 挑战 
windows.chall.login 以完成挑战! 
thumbnail.upload.limit 失败. {0} KB 缩略图限制 
image.upload.limit 失败. {0} KB 图片限制 
...
custom.map.upload.limit 失败. 角色游戏数据限制为 500k 
...
server.config.lives 生命数 
server.config.gameTime 时间 (分钟) 
...
server.config.airStrf 空中 Strafing 
...
server.config.canSlide 启用 Sliding 
...
server.config.forceDefault 强制默认设置
server.config.warmupTime 热身时间 
server.config.objtvTime 客观时间
server.config.forceSpawn 自动重生时间 
server.config.scoreLimit 得分限制 
server.config.keepTScore 保留队伍分数
server.config.forceC 强制角色模式
server.config.logTim 游玩时间(比赛, 跑酷)
server.config.hitBoxPad 击中判断模型倍率 
server.config.hpRegen 血量回复 
server.config.disableB 解除地图边界 
server.config.throwMel 启用扔飞刀 
...
social.since 自从 
social.user.maps 用户地图 
social.user.mods 用户插件 
social.maps.none 没有找到地图... 
social.mods.none 没有找到插件... 
...
respawn.auto 自动重生在 {0} 秒内
custom.host.ranked 排位赛中无法举办新游戏。
funds.insufficient 资金不充足 
funds.out 您目前已用完您的 Krunkies. 
custom.passcode.long 密码太长
custom.passcode.input 请输入此服务器密码以加入游戏
custom.tryagain 请重试
purchase.kr.success 已添加 {0} KR 到您的帐户
limited.purchase.ask 您确定希望购买 [{0}] 为 {1} KR?
limited.purchase.success 已添加 {0} 到您的 存货
pretend.exit 再次点击 [{0}] 以退出
settings.loaded 设置已加载
settings.loaded.none 无设置找到
account.login.required 您必须先登录
account.banned.hack 此账号已被禁用因作弊
account.banned.appeal 如果您想申诉你的禁令，请联系:
account.delete 您可以请求删除您的帐户，如果此请求没有在14天内取消，您所有的帐户数据将会永久清除.
account.delete.request 您确定您希望请求删除您的帐户?
account.delete.cancel 您确定您希望取消删除您的帐户?
spin.free.available 免费 KR 可用!
spin.free.claim 您必须每小时完成一场比赛以获得您的免费 KR 旋转盘.
spin.free.disable 此弹窗可被禁止在通用设定里
mod.reset.0 将会起效在您重生以后.
mod.reset.1 此地图物体将不会重置
windows.profile.picture 更改图像
stats.assists 助攻
stats.nukes 核武
stats.melee 混战
stats.fistkills 拳击
stats.thrownkills 飞刀
stats.headshots 爆头
stats.wallbangs 穿击
stats.sprays 涂鸦已放置
windows.host.default.settings 启用默认设置允许存档玩家进度及高分
windows.host.default.commands *主人命令将会被禁用在此模式像: /noclip /god /smite 等.
windows.host.rewards 启用 KR 奖励将会强制此服务器使用默认设置 & 允许玩家获得 KR 从此地图基金:
windows.store.wheels.sub 试试您的运气以有机会获得新皮肤!
windows.store.currency * 这些价格可以从美元转换到您的当地货币以汇率计算由付款提供商或银行
windows.store.creator 考虑支持您最喜欢的 Krunker 内容创建者通过使用他们的代码
windows.chall.customs 挑战不能被进行在自定义游戏内
twitch.link 您确定希望连接您的 Twitch 帐户?
twitch.unlink 您确定希望取消连接您的 Twitch 帐户?
windows.clan.leave 您确定希望离开您的部落?
windows.clan.delete 您确定希望删除您的部落?
windows.clan.kick 您确定希望踢出 {0} 从您的部落?
windows.store.premium.purchase 您确定希望购买 {0} 天的高级会员?
windows.playerlist.ban 您确定希望禁止并踢出 {0} 从此游戏?
windows.playerlist.flag 您确定希望标签 {0}?
windows.playerlist.unflag 您确定希望取消标签 {0}?
windows.playerlist.punish 您确定希望采取行动对 {0}?
`;
