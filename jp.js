...
generic.defeat 敗北
generic.victory 勝利
generic.matchover 試合終了
generic.matchaband 放棄されました
generic.follow フォロー
...
generic.lose 敗北数
generic.clan クラン
generic.games.played 参加ゲーム数
generic.games.won 勝利ゲーム数
generic.games.lost 敗北ゲーム数
generic.timep プレイ時間
generic.kills キル数
generic.deaths デス数
generic.kdr KDR
generic.time 時間
generic.logout ログアウト
generic.logout.sessions 全てのセッションからログアウト
generic.username ユーザー名を入力
generic.password パスワードを入力
generic.register 登録
generic.login ログイン
...
settings.reset リセット
settings.reset.confirm 全ての設定をリセットしますか?
settings.import インポート
settings.export エクスポート
settings.none 設定が見つかりません
settings.backup 設定のバックアップ
settings.controls.change キーの設定
settings.controls.press どれかキーを押してください
settings.controls.leaderboard インゲームリーダーボードのトリガータイプ
settings.controls.voicechat ボイスチャットのトリガータイプ
settings.local.header ローカライゼーション <span id="requiresRestart"><span style="color: #eb5656">*</span> 再起動が必要です</span>
...
settings.network.lagComp ラグを修正
...
settings.experimental.aimFreezeFix 標的のフリーズを修正
settings.experimental.mouseFlickFix 標的の飛びの補正
settings.experimental.shaderRendering インスタンスレンダリング
settings.experimental.mouseAccel マウス加速
settings.experimental.tbInterp 動きの補完
...
settings.client.colorProfile カラープロフィール
settings.client.resourcePacks リソースパック
settings.dev.header 開発者
settings.dev.forceUpdate 強制的にスキンをアップデート
settings.dev.forceRegen 常にプレイヤーを再生
...
settings.quality.trails 他のプレイヤーの弾道
...
settings.post.bloomThreshold ブルームの限界点
...
settings.interface.theme ゲームテーマ
...
settings.interface.spectators 観戦者人数を表示
settings.interface.speed 移動スピードを表示
settings.interface.speedOffX スピード表示X座標
settings.interface.speedOffY スピード表示Y座標
settings.interface.speedOpacity スピード透明度
settings.interface.speedScale スピードスケール
settings.interface.speedColor スピードの色 (現在)
settings.interface.speedColorMax スピードの色 (最大)
...
settings.interface.nametagOpac ネームタグ透明度
settings.interface.nametagScale ネームタグスケール
settings.interface.nametagStyle.health 体力のみ
...
settings.interface.healthNum ネームタグ体力数
settings.interface.healthColT ネームタグ体力の 色 (チーム)
settings.interface.healthColE ネームタグ 体力の色 (敵)
settings.interface.xpBarType 経験バータイプ
settings.interface.xpBarCol 経験バーの色
settings.interface.xpBarCol2 経験バーの色 2
settings.interface.xpBarOpac バーの透明度
settings.interface.adsObjOpac 標的のオブジェクト透明度
settings.medals.header メダル
settings.medals.show メダルを表示
settings.medals.classic 古いメダル
settings.medals.sound メダルの効果音
settings.medals.scale メダルスケール
settings.medals.xOff メダルX座標
settings.medals.yOff メダルY座標
settings.crosshair.header クロスヘア
settings.crosshair.type タイプ
settings.crosshair.type.1 ダイナミック
settings.crosshair.type.2 形
settings.crosshair.type.3 レイヤード
settings.crosshair.type.4 画像
settings.crosshair.type.5 精度
...
settings.crosshair.shadow.thickness 影の太さ
settings.crosshair.size 大きさ
settings.crosshair.thickness 太さ
settings.crosshair.gap ギャップ
settings.crosshair.dot 点
settings.crosshair.opacity.use カスタム透明度を使用
settings.crosshair.opacity.custom カスタム透明度
settings.crosshairm.header クロスヘア (投じたもの)
settings.crosshairm.type タイプ
settings.crosshairm.type.1 形
settings.crosshairm.type.2 画像
settings.crosshairm.type.3 精度
...
settings.crosshairm.shadow.thickness 影の太さ
settings.crosshairm.size 大きさ
settings.crosshairm.thickness 太さ
settings.crosshairm.gap ギャップ
settings.crosshairm.dot 点
settings.crosshairm.opacity.use カスタム透明度を使用
settings.crosshairm.opacity.custom カスタム透明度
settings.hitmarker.header ヒットマーカー
settings.hitmarker.color 色
settings.hitmarker.kcolor キル色
settings.hitmarker.thickness 太さ
settings.hitmarker.opacity 透明度
settings.hitmarker.leng 長さ
settings.hitmarker.spacing 間隔
settings.hitmarker.animD アニメーションサイズ
settings.hitmarker.animS アニメーションスピード
settings.hitmarker.hitm 表示
settings.hitmarker.hitmFad フェードスピード
settings.hitmarker.custom ヒットマーカー画像
settings.hitmarker.custom.paste ヒットマーカー画像URL
settings.onKillS.style.0 デフォルト
...
settings.gameprivacy.showRegion 地域の情報を表示
...
settings.gameprivacy.custom カスタムバッジを表示
...
settings.gameplay.aimsensX 照準のX感度
settings.gameplay.aimsensY 照準のY感度
settings.gameplay.challenge チャレンジモード
settings.gameplay.invert Y軸反転
settings.gameplay.onkillS オンキル
...
settings.controller.aimsensX 照準のX感度
settings.controller.aimsensY 照準のY感度
settings.controller.deadZoneL デッドゾーン (左)
settings.controller.deadZoneR デッドゾーン (右)
settings.controller.triggerThres トリガー限界点
settings.controller.vibration 振動
settings.controller.gradSpeed 加速を緩やかにする
settings.controller.invert Y軸反転
settings.mobile.header モバイル
settings.mobile.sensitivityX X感度
settings.mobile.sensitivityY Y感度
settings.mobile.aimsensX 照準のX感度
settings.mobile.aimsensY 照準のY感度
settings.mobile.vibration 振動
settings.mobile.gradSpeed 加速を緩やかにする
settings.mobile.invert Y軸反転
...
settings.audio.micquality マイク音質
...
settings.viewmodel.vmSetts モデル表示の設定
...
settings.viewmodel.show.primary メインの武器を表示
settings.viewmodel.show.secondary サブの武器を表示
settings.viewmodel.roundArms 腕を丸くする
settings.viewmodel.show.melee ナイフを表示
settings.viewmodel.show.ads 照準時に武器を隠す
settings.viewmodel.toggleAim エイム切り替え
settings.viewmodel.show.hands 手を表示
settings.viewmodel.leftHand 左利きモード
settings.viewmodel.aimAnim 武器エイムアニメーション
settings.viewmodel.rot 武器回転
...
settings.viewmodel.weapReloadY 武器リロード動作の 座標
settings.viewmodel.yOffADS 標的中の武器 Y 座標
settings.viewmodel.adsFovMlt 標的 FOV 倍率
settings.viewmodel.toggleADS 標的切り替え
settings.viewmodel.wallLean 壁スライド/ジャンプリーン
settings.viewmodel.wallLeanMlt 壁スライド/ジャンプリーン
settings.editing.header 編集
settings.editing.health.high HUD 体力がある
settings.editing.health.low HUD 体力がない
settings.editing.speedLines スピードライン
settings.editing.spdLinesCol スピードラインの色
settings.editing.score.color ポップアップスコアの色
settings.editing.score.show ポップアップスコアを表示
settings.editing.score.scale ポップアップスコアスケール
...
settings.editing.progm.color チャージバーの色
settings.editing.progmo.color オーバーチャージ時の色
settings.editing.progm.opacity チャージバーの透明度
settings.editing.progm.scale チャージバーの大きさ
settings.editing.progm.shadow チャージバーの影
settings.editing.progmOffX チャージバーの X 座標
settings.editing.progmOffY チャージバーの Y 座標
settings.editing.progmRot チャージバーの角度
...
settings.editing.depth 深さマップ
settings.editing.green グリーンスクリーン
settings.editing.trailcol 弾丸トレイルの色
settings.editing.ropecol グラップルロープの色
...
settings.mods.load モッドをロード
settings.mods.logo ロゴの変更を許可
settings.mods.auto モッドを自動ロード
...
settings.mods.dot.paste レティクルURL
settings.mods.endmessage 試合終了メッセージ
settings.mods.profile プロフィール画像
settings.mods.profile.paste プロフィール画像URL
settings.mods.ammo 弾丸アイコン画像
settings.mods.ammo.paste 弾丸アイコン画像 URL
settings.mods.kills キルアイコン画像
settings.mods.kills.paste キルアイコン画像URL
settings.mods.deaths デスアイコン画像
settings.mods.deaths.paste デスアイコン画像URL
settings.mods.streak ストリークカウンターアイコン画像
settings.mods.streak.paste ストリークカウンターアイコン画像URL
settings.mods.timer タイマーアイコン画像
settings.mods.timer.paste タイマーアイコン画像URL
settings.mods.usedamage ダメージオーバーレイを使用
settings.mods.damage ダメージオーバーレイ画像
...
windows.servers.online ゲーム内に{0}人
windows.servers.social ソーシャルに{0}人
windows.servers.editor エディターに{0}人
...
windows.loadout.color.skin 肌の色
windows.loadout.color.chat チャット名の色
windows.loadout.color.hair 髪の色
windows.loadout.dye 服装
windows.loadout.pet ペット
windows.loadout.wrist 腕
windows.loadout.stat キルカードの統計
windows.loadout.flag 国旗
windows.loadout.badge カスタムバッジ
windows.loadout.streaks ストリーク
windows.mods.drop ここにモッドファイルをドロップするか、クリックしてください
windows.mods.paste モッドを貼り付け
windows.mods.load モッドをロード
windows.mods.none モッドが見つかりません
windows.mods.header モッドマネージャー
windows.mods.guide モッドガイド
windows.mods.list モッドリスト
windows.mods.load.header モッドをロード
windows.mods.publish モッドを公開する
windows.mods.viewer モッドビューワー
...
windows.controls.prop 小道具の選択　(ホールド)
...
windows.controls.resetLast 直近のチェックポイントにリセットする (パルクール等)
windows.controls.pretend ゲームを非表示にする
windows.controls.noclipSB ノークリップ
windows.controls.godModeSB ゴッドモード
windows.controls.killSB キル
...
windows.host.settings サーバー設定
windows.host.preset ホストプリセット
windows.host.preset.load プリセットロード中...
windows.host.preset.name プリセット名
windows.host.start ゲームを始める
windows.host.rehost ゲームを始める (プレーヤーを連れてくる)
windows.spray.header スプレーを選択
windows.spray.default デフォルトスプレー
windows.spray.spin スプレー
windows.maps.header カスタムゲーム
windows.maps.none ゲームが見つかりません!
windows.maps.name ゲーム名
windows.maps.editor ゲームエディター
windows.maps.publish ゲームを公開する
windows.maps.community 開発コミュニティー
windows.publish.map.header ゲームを公開／更新する
windows.publish.map.thumbnail サムネイルなし
windows.publish.map.paste ゲームデータを貼り付けてください
windows.publish.map.update 公開/更新
windows.publish.map.login ログインしてゲームを作成·アップロードしよう!
...
windows.clans.create クランを作る
windows.clans.name クラン名
windows.clans.view クランを見る
windows.clans.join クランに参加する
windows.clans.login ログインしてクランを作成·参加する!
windows.store.header ストア
windows.store.spin {0} スピン
windows.store.agree この度購入を通して、{0}規約に同意したものと見なされます
...
windows.store.premium2 Krunker プレミアム
...
windows.store.login ストアからアイテムを購入するにはログインしてください
windows.store.purchasing 購入中...
windows.store.unboxed {0}{1}を獲得しました
windows.store.found {0}{1}を発見しました
...
windows.waist.header 腰アイテムを選択
windows.face.header 顔を選択
windows.melee.header ナイフを選択
windows.attach.header アタッチメントを選択
windows.reticle.header レティクルを選択
windows.reticle.unlocked レベル{0}でアンロック
windows.reticle.req レベル{0}が必要
windows.dye.header 服装を選択
windows.dye.default デフォルト服装色
windows.dye.spin 服装色変更
windows.changelog.header 変更履歴
windows.mods.community.header コミュニティーモッド
windows.mods.community.fav あなたのお気に入り
windows.mods.community.new 最新モッド
windows.mods.community.hot 人気
windows.mods.community.name モッド名
windows.mods.community.none モッドが見つかりません
windows.publish.mod.header モッドを公開
windows.publish.mod.thumbnail サムネイルなし
windows.publish.mod.name モッド名
windows.publish.mod.paste モッド URL
windows.publish.mod.update 公開/更新
windows.publish.mod.login ログインしてモッドを作成·アップロードする!
...
windows.client.windows Windowsインストーラー
windows.client.mac macOSインストーラー
windows.client.linux Linuxインストーラー
windows.ranked.header ランクマッチ
windows.ranked.login ログインしてランクマッチをプレイする!
...
windows.chall.login ログインしてチャレンジを完了させよう!
windows.spin.header プライズホイール
thumbnail.upload.limit 失敗しました。サムネイルサイズ制限は{0}kbです
image.upload.limit 失敗しました。画像サイズ制限は{0}kbです
thumbnail.upload.error サムネイルエラー
mod.extracting モッド抽出中 {0}/{1}
mod.disabled モッドが無効になっています
mod.error モッドエラー!
mod.loading モッドをロード中...
mod.invalid 無効なモッドファイル!
matchmaker.full 満
...
server.config.minPlayers 最小プレーヤー
server.config.lives 人生
server.config.gameTime ゲーム時間 (分)
server.config.gravMlt 重力
server.config.tickRI 高ティックレート
server.config.maxPS 40人のサーバー
server.config.promServ サーバーを宣伝する
server.config.jumpMlt ジャンプ力
server.config.airStrf エアーストレイフ
server.config.deltaMlt 時間スケール
server.config.strafeSpd ストレイフ速度
...
server.config.frFire フレンドリーファイア
...
server.config.canSlide スライディング
server.config.wallJP 壁ジャンプ力
server.config.autoJump 自動ジャンプ
server.config.bDrop 弾道落下
...
server.config.fallDmgThr 落下ダメージ限界点
...
social.login.buy 購入するにはログインしてください
social.login.sell 販売するにはログインしてください
social.login.gift ギフトを送るにはログインしてください
social.login.proccessing ログイン中...
social.since 作成日
social.user.maps ユーザーゲーム
social.user.mods ユーザーモッド
social.maps.none ゲームが見つかりません...
social.mods.none モッドが見つかりません
social.market.price.low 最安値
social.market.price.list リスト価格を入力 -
social.market.searching 検索中
social.market.listed {0} 前にマーケットに出されました
social.market.list アイテムをマーケットに出す
social.market.unlist マーケットから外す
social.market.unlisting アイテムをマーケットから外しています
...
social.market.wrist 腕アイテム
social.market.melee ナイフアイテム
...
social.market.gift.amount ギフトの金額
social.market.fee.gift 手数料なし
social.market.gift KRをギフトする
social.market.gift.msg メッセージを添える
...
stats.assists アシスト
stats.nukes ニューク
stats.slimers スライマーズ
stats.juggernauts ジャガーノート
stats.juggernauts.kills ジャガーノートでのキル回数
stats.juggernauts.killed ジャガーノートにキルされた回数
stats.warmachines ウォーマシン
stats.melee ナイフキル
stats.fistkills 拳キル
stats.thrownkills 投げナイフキル
stats.headshots ヘッドショット
stats.wallbangs 壁の打ち抜きキル
...
windows.store.currency *米ドルでの金額表記はあなたの国の通貨に変換され、その際の為替レートは支払いサービスや銀行が定めたものによります
...
windows.playerlist.ban 本当に{0}をこのゲームから禁止しますか?
...
social.profile.sales.market マーケットの売上
social.profile.skins スキン [{0}]
social.profile.skins.none このユーザーが公開したスキンはありません
social.profile.games ゲーム [{0}]
social.profile.games.none このユーザーが公開したゲームはありません
social.profile.assets アセット [{0}]
social.profile.assets.none このユーザーが公開したアセットはありません
social.profile.mods モッド [{0}]
social.profile.mods.none このユーザーが公開したモッドはありません
social.search 検索結果
...
social.trades.warning このトレードではあなたは何もアイテムを手に入れません!
...
chall.name.hs {0} ヘッドショットを獲得する {1}
chall.name.ns {0} ノースコープを獲得する {1}
chall.name.ls {0} レッグショットを獲得する {1}
chall.name.tmk Get {0} throwing knife kills {1}
chall.name.fb {0} ファーストブラッドを獲得する {1}
chall.name.mk {0} ナイフキルを獲得する {1}
chall.name.fk {0} パンチキルを獲得する {1}
chall.name.qs {0} クイックスコープを獲得する {1}
chall.name.wb {0} 壁の打ち抜きキルを獲得する {1}
chall.name.airk {0} 空中キルを獲得する {1}
chall.name.lns {0} ロングショットを獲得する {1}
chall.name.tk {0} ターボキルを獲得する {1}
chall.name.drk {0} ドリフトキルを獲得する {1}
chall.name.kstk {0} 連続キルを獲得する {1}
chall.name.w {0} マッチ勝つ
chall.name.d {0} 回死ぬ
chall.name.score {0} スコアを獲得する
chall.name.dmg {0} ダメージを与える {1}
chall.name.bzk {0} バズキルを獲得する {1}
chall.name.cc {0} クロースコールを獲得する {1}
chall.name.rk {0} リベンジキルを獲得する {1}
event.doubleXP このマッチではクラス経験値が2倍になります
ranked.join ランクマッチに参加しました。マッチを放棄すると一時的に禁止されます
ranked.progress マッチ中
ranked.team チームに入ってください
ranked.switch マッチ中にはクラスを変更できません
ranked.spectate ランクマッチでは観戦できません
ranked.login スポーンするにはログインしてください
...
modes.round.loss このラウンドはもう勝てません
...
commands.suspect.left 容疑者がゲームを退出しました
...
commands.forfeit.limit 降参の投票は1マッチにつき1回までです
...
server.message.kicked {0}がキックアウトされました
server.message.banned {0}が禁止されました
server.message.votekicked {0}が投票によりキックアウトされました
server.message.arrested {0}がK.P.Dにより逮捕されました
event.easter.golden.spawn 金色の卵が近くにあります
event.easter.golden.despawn 金色の卵が消えしました
event.easter.found.new {0}は{1}/{2}の卵を見つけました
