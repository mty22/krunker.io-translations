module.exports = `
menu.btn.ranked Kompetitív
menu.btn.shop Bolt
menu.btn.social Közösségi
menu.btn.maps Pályák
menu.btn.mods Modok
menu.btn.settings Beállítások
menu.btn.customize Személyreszabás
menu.btn.invite Meghívás
menu.btn.invite.clicked Kimásolva
menu.btn.join Belépés
menu.btn.host Játék hosztolása
menu.btn.browser Szerverek
generic.wait Kérlek várj...
generic.loading BETÖLTÉS...
generic.none Semmi
generic.connecting KAPCSOLÓDÁS...
generic.select Kiválaszt
generic.delete Töröl
generic.save Ment
generic.load Betölt
generic.search Keres
generic.leave Kilép
generic.default Alapméretezett
generic.submit Beküld
generic.create Létrehoz
generic.random Véletlen
generic.failed Sikertelen
generic.success Sikeres!
generic.name Név
generic.level Szint
generic.score Pontszám
generic.off ki
generic.defeat VERESÉG
generic.victory GYŐZELEM
generic.matchover VÉGE A MECCSNEK
generic.matchaband MECCS ELHAGYVA
generic.follow Követés
generic.unfollow Kikövetés
generic.followers Követők
generic.following Követettek
generic.games Játékok
generic.wins Győzelmek
generic.lose Vereségek
generic.clan Klán
generic.games.played Játszott menetek
generic.games.won Nyert menetek
generic.games.lost Vesztett menetek
generic.timep Játékkal töltött idő
generic.kills Őlések
generic.deaths Halálok
generic.kdr KDA
generic.time Idő
generic.logout Kijelentkezés
generic.logout.sessions Kijelentkezés mindenhonnan
generic.username Felhasználónév megadása
generic.password Jelszó megadása
generic.register Regisztrálás
generic.login Bejelentkezés
generic.accuracy Pontosság
...
leaderboard.empty Üres szoba
popup.checkpoint Ellenörző pont!
app.play KATTINTS A JÁTÉKHOZ
app.spectate KATTINTS A MEGFIGYELÉSHEZ
app.play.mobile PÖTTYINTS A JÁTÉKHOZ
app.spectate.mobile PÖTTYINTS A MEGFIGYELÉSHEZ
app.play.controller NYOMD MEG A STARTOT
app.spectate.controller NYOMD MEG A STARTOT A MEGFIGYELÉSHEZ
purchase.error Hiba történt
purchase.error.click kattints ide</a> és próbáld újra!
purchase.error.limit Túl lépted a napi tranzakciós határt
settings.reset Visszaállítás
settings.reset.confirm Biztos vissza akarod állítani minden beállításodat?
settings.import Betöltés
settings.export Lementés
settings.none Nem találtunk beállításokat
...
settings.dev.extraBan Extra Ban Információ
settings.chat.header Csevegés
settings.chat.chat Csevegés mutatása
settings.chat.chat.all Mindig
settings.chat.chat.focus Amíg fókuszban van
settings.chat.messages Játékos üzenetek mutatása
settings.chat.unboxings Nyitások mutatása
settings.chat.chatOp Csevegés átlátszósága
settings.chat.chatBGOp Csevegés hátterének átlátszósága
settings.chat.chatHeight Csevegés magassága
settings.chat.chatTimer Csevegés idő (s)
settings.chat.chatTextOutline Csevegés Szöveg körvonal
settings.chat.chatFilter Káromkodás szűrő
settings.quality.header Teljesítmény
settings.quality.updRate Képkocka Határ
settings.quality.rendDst Renderelési távolság
settings.quality.res Felbontás
settings.quality.part Részecskék
settings.quality.mapDet Pálya részletek
settings.quality.noTex Nincs textúra
settings.quality.partdist Részecske távolság
settings.quality.renderdist Renderelési távolság
settings.quality.reflection Visszaverődési minőség
settings.quality.antiAlias Antialiasing
settings.quality.shadows Árnyékok
settings.quality.softShad Lágy árnyékok
settings.quality.highResShad Nagy-felbontású Árnyékok
settings.quality.shadowsDynamic Dinamikus árnyékok
settings.quality.trails Lövedék Pályák
settings.quality.yourTrails Saját pályák
settings.quality.mflash Torkolattűz
settings.quality.flap Mesterlövész fedél
settings.quality.lowSpec Alacsony specifikáció
settings.quality.ambient Környezeti árnyékolás
settings.quality.ambientOld Régi árnyékolás (Amikor lehetséges)
settings.quality.textureAnim Textúra animációk
settings.quality.objectAnim Tárgy animációk
settings.quality.screenShake Képernyő rázás
settings.quality.weaponShine Fegyver csillogás
settings.quality.rendGamma Gamma
settings.quality.lighting Világítás
settings.quality.showExplo Robbanások mutatása
settings.quality.aspectRatio Képarány
settings.post.header Utófeldolgozás
settings.post.post Utófeldolgozás
settings.post.bloom Fényesség
settings.post.bloomThreshold Fényesség küszöb
settings.post.bloomStrength Fényesség erőssége
settings.post.bloomRadius Fényesség mérete
settings.post.ssao SSAO
settings.post.ssaoRadius SSAO Méret
...
settings.interface.ping Ping mutatása
settings.interface.net-stats Internet statisztikák mutatása
settings.interface.fps FPS mutatása
settings.interface.deaths Halál számláló mutatása
settings.interface.kd K/D Számláló mutatása
settings.interface.kills Ölés számláló mutatása
settings.interface.streak Sorozat számláló mutatása
settings.interface.score Pont számláló mutatása
settings.interface.spectators Megfigyelő számláló mutatása
settings.interface.speed Sebesség mutatása
settings.interface.speedOffX Sebesség vízszintes eltolása
settings.interface.speedOffY Sebesség függőleges eltolása
settings.interface.speedOpacity Sebesség átlátszóság
...
settings.interface.nametagStyle.all Minden
...
settings.crosshair.type.5 Precizitás
settings.crosshair.style Stílus
settings.crosshair.style.0 Kereszt
settings.crosshair.style.1 Üres kör
settings.crosshair.style.2 Telített kör
settings.crosshair.style.3 Üres négyzet
...
settings.crosshair.shadow.thickness Árnyék vastagsága
settings.crosshair.size Méret
settings.crosshair.thickness Vastagság
settings.crosshair.gap Rés
...
settings.hitmarker.thickness Vastagság
...
settings.hitmarker.custom.paste Találatjelző kép URL-je
settings.onKillS.style.0 Alapértelmezett
settings.onKillS.style.1 Felbontás csökkentése
settings.onKillS.style.2 FOV csökkentése
settings.onKillS.style.3 FÖV növelése
settings.serverb.header Szerver böngésző
settings.serverb.oldBrowser Régi böngésző
settings.serverb.defaultRegionOnly Csak alapértelmezett régió
settings.gameprivacy.header Játékélmény
...
settings.gameplay.aimsensY Y Célzás érzékenység
settings.gameplay.challenge Kihívás mód
settings.gameplay.invert Y tengely megfordítása
settings.gameplay.onkillS Ölés esetén
settings.gameplay.scrollDir Görgetés iránya
settings.controller.header Kontroller
settings.controller.sensitivityX X Érzékenység
settings.controller.disableCons Kontrollerek kikapcsolása
settings.controller.sensitivityY Y Érzékenység
settings.controller.aimsensX X Célzás érzékenység
settings.controller.aimsensY Y Célzás érzékenység
settings.controller.deadZoneL Holt zóna (Bal)
settings.controller.deadZoneR Holt zóna (Jobb)
settings.controller.triggerThres Kiváltó küszöb
settings.controller.vibration Vibrálás
settings.controller.gradSpeed Fokozatos sebesség
settings.controller.invert Y tengely megfordítása
settings.mobile.header Mobil
settings.mobile.sensitivityX X Érzékenység
settings.mobile.sensitivityY Y Érzékenység
settings.mobile.aimsensX X Célzás érzékenység
settings.mobile.aimsensY Y Célzás érzékenység
settings.mobile.vibration Vibrálás
settings.mobile.gradSpeed Fokozatos sebesség
settings.mobile.invert Y tengely megfordítása
settings.audio.header Hang
...
settings.viewmodel.leaning Fegyver hajlás
settings.viewmodel.show.primary Elsődleges fegyver mutatása
settings.viewmodel.show.secondary Másodlagos fegyver mutatása
settings.viewmodel.roundArms Lekerekített kezek
settings.viewmodel.show.melee Kézi fegyver mutatása
settings.viewmodel.show.ads Fegyver elrejtése vélzáskor
settings.viewmodel.toggleAim Célzás kapcsolása
settings.viewmodel.show.hands Kezek mutatása
settings.viewmodel.leftHand Bal kezes
settings.viewmodel.aimAnim Célzási animáció
settings.viewmodel.rot Fegyver forgatás
settings.viewmodel.xOff Fegyver X eltolás
settings.viewmodel.yOff Fegyver Y eltolás
settings.viewmodel.zOff Fegyver Z eltolás
settings.viewmodel.weapSwapY Fegyver váltás Y
...
settings.editing.speedLines Sebesség vonalak
settings.editing.spdLinesCol Sebesség vonalak színe
settings.editing.score.color Ölési pontszám színe
settings.editing.score.show Ölési pontszám mutatása
settings.editing.score.scale Ölési pontszám mérete
settings.editing.score.shadow Ölési pontszám árnyéka
settings.editing.scoreOffX Ölési pontszám X eltolás
settings.editing.scoreOffY Ölési pontszám Y eltolás
settings.editing.prog.color Fejlődésmutató szín
settings.editing.prog.opacity Fejlődésmutató átlászóság
settings.editing.prog.scale Fejlődésmutató méret
settings.editing.prog.shadow Fejlődésmutató árnyék
settings.editing.progOffX Fejlődésmutató X eltolás
...
settings.editing.progmOffX Felhúzásmutató X eltolás
settings.editing.progmOffY Felhúzásmutató Y eltolás
settings.editing.progmRot Felhúzásmutató elforgatás
...
settings.shaders.header Árnyékoló bemenet
settings.mods.header Személyreszabás
settings.mods.load Modok betöltése
settings.mods.logo Logo változtatás engedélyezése
settings.mods.auto Modok automatikus betöltése
settings.mods.borders Scope határok
settings.mods.borderCol Scope határok színe
settings.mods.borderOpac Scope jatárok átlátszósága
settings.mods.scope Scope kép
settings.mods.scope.paste Scope kép URL
settings.mods.scope.opacity Scope átlátszóság
settings.mods.scope.width Scope kép szélesség
settings.mods.scope.height Scope kép magasság
settings.mods.dot Hajszálkereszt kép
settings.mods.dot.width Hajszálkereszt kép szélessége
settings.mods.dot.height Hajszálkereszt kép magassága
settings.mods.dot.paste Hajszálkereszt URL
settings.mods.endmessage Meccs záró üzenet
settings.mods.profile Profil kép
settings.mods.profile.paste Profil kép URL
settings.mods.ammo Lőszer ikon kép
settings.mods.ammo.paste Lőszer ikon kép URL
settings.mods.kills Ölések ikon kép
settings.mods.kills.paste Ölések ikon kép URL
settings.mods.deaths Halálok ikon kép
settings.mods.deaths.paste Halálok ikon kép URL
settings.mods.streak Sorozat számláló ikon kép
settings.mods.streak.paste Sorozat számláló ikon kép URL
settings.mods.timer Időmérő ikon kép
settings.mods.timer.paste Időmérő ikon kép URL
settings.mods.usedamage Sebzés átfedés használata
settings.mods.damage Sebzés átfedés kép
settings.mods.damage.paste Sebzés átfedés kép URL
...
windows.servers.none Egy szerver sincs...
windows.servers.host + Játék hosztolása
windows.servers.hide Megteltek elrejtése
...
windows.loadout.hat Kalap
windows.loadout.back Test
windows.loadout.waist Derék
windows.loadout.shoe Cipők
windows.loadout.face Arc
windows.loadout.spray Spré
windows.loadout.color.skin Bőrszín
windows.loadout.color.chat Csevegés név szín
...
windows.mods.none Nem találtunk modokat
windows.mods.header Mod menedzser
windows.mods.guide Mod útmutató
windows.mods.list Modok listája
windows.mods.load.header Modok betöltése
...
windows.controls.swap Másodlagos fegyver
windows.controls.melee Kés
windows.controls.equip Felszerelés
windows.controls.chat Csevegés
windows.controls.voice Hangüzenet
windows.controls.list Játékos lista
windows.controls.board Ranglista
windows.controls.interact Interakció
windows.controls.interactSec Másodlagos interakció
...
windows.host.preset.name Minta neve
windows.host.start Játék indítása
windows.host.rehost Játék indítása (Kellenek még játékosok)
windows.spray.header Spré kiválasztása
windows.spray.default Ingyenes spré
windows.spray.spin Spré
windows.maps.header Egyedi játékok
windows.maps.none Nem találtunk játékokat!
windows.maps.name Játék neve
windows.maps.editor Játék készítő
windows.maps.publish Játék publikálása
windows.maps.community Fejlesztői közösség
windows.publish.map.header Publikáld vagy frissítsd a játékot
windows.publish.map.thumbnail Nincs indexkép
windows.publish.map.paste Játék adat beillesztése
windows.publish.map.update Publikál/Frissít
windows.publish.map.login hogy létre tudj hozni és fel tudj tölteni játékokat!
windows.theatre.header Színház mód
windows.theatre.record Felvétel engedélyezése
windows.theatre.key Felvétel gomb
windows.clans.header Klánok
windows.clans.members Tagok ({0})
windows.clans.requests Kérések
windows.clans.requests.none Nincsenek kérések
windows.clans.page [{0}] Klán oldal
windows.clans.create Klán létrehozása
windows.clans.name Klán neve
windows.clans.view Klánok megtekintése
windows.clans.join Belépés a klánba
windows.clans.login hogy létre tudj hozni és be tudj lépni klánokba!
windows.store.header Bolt
windows.store.spin {0} Pörgetés
windows.store.agree A megvétellel elfogadod a {0} Feltételeket
windows.store.purchase KR vásárlása
windows.store.voucher Utalvány beváltása
windows.store.voucherinfo Szerezz utalványokat bizonyos Streamerektől és Eseményeken
windows.store.market Piac
windows.store.market2 Krunker Piac
windows.store.premium Prémium vásárlása
windows.store.premium2 Krunker prémium
windows.store.buyP Válassz egy becenevet és még több mindent ezzel:
windows.store.buy Vegyél és adj el dolgokat itt:
windows.store.wheels Szerencse kerék
windows.store.unlock Oldj fel új fegyver kinézeteket és tárgyakat
windows.store.amount {0} KR-ed van
...
windows.skin.header Kinézet kiválasztása
windows.hat.header Kalap kiválasztása
windows.back.header Hát kiválasztása
windows.waist.header Derék kiválasztása
windows.face.header Arc kiválasztása
windows.melee.header Kés kiválasztása
windows.attach.header Tartozék kiválasztása
windows.reticle.header Hajszálkereszt kiválasztása
windows.reticle.unlocked Feloldva a {0}. szinten
windows.reticle.req Szükséges szint: {0}
windows.dye.header Festék kiválasztása
windows.dye.default Alapértelmezett festék
windows.dye.spin Festék
windows.changelog.header Változási napló
windows.mods.community.header Közösségi modok
windows.mods.community.fav Kedvencek
windows.mods.community.new Új modok
windows.mods.community.hot Népszerű
windows.mods.community.name Mod neve
windows.mods.community.none Nem találtunk ilyen modokat
windows.publish.mod.header Mod publikálása
windows.publish.mod.thumbnail Nincs indexkép
windows.publish.mod.name Mod neve
windows.publish.mod.paste Mod URL-je
windows.publish.mod.update Publikálás/Frissítés
...
windows.players.none Jeleneleg nincsenek játékosok
windows.join.header Belépés
windows.join.code Játék URL/Kód megadása
windows.client.header Kliens
windows.client.windows Windows telepítő
windows.client.mac macOS telpítő
windows.client.linux Linux telepítő
...
streamers.none Nincs aktív közvetítés!
error.extentions Ha van bármilyen bővítményed, kapcsold ki!
error.seek Próbálj meg keresni egy új játékot a következő megnyomásával: 
...
server.config.gameTime Perc
server.config.gravMlt Gravitáció
server.config.tickRI Magas tickrate
server.config.maxPS 40 Fős szerver
server.config.promServ Szerver népszerűsítése
server.config.jumpMlt Ugrás ereje
server.config.airStrf Légi kanyarodás
server.config.deltaMlt Idő sebessége
server.config.strafeSpd Kanyarosdás sebessége
server.config.fiRat Tüzelési sebesség
server.config.reSpd Újratöltési sebesség
server.config.slidTime Csúszási idő
server.config.fixMov Javított mozdás
server.config.slidSpd Csúszási sebesség
server.config.healthMlt Élet többszörözés
server.config.impulseMlt Fegyver hatótávolság
server.config.nameTeam1 Csapat 1 neve
server.config.nameTeam2 Csapat 2 neve
server.config.nameTeam3 Csapat 3 neve
server.config.nameTeam4 Csapat 4 neve
server.config.nameTeam5 Csapat 5 neve
server.config.t1Dmg Csapat 1 sebzése
server.config.t2Dmg Csapat 2 sebzése
server.config.t3Dmg Csapat 3 sebzése
...
server.config.noSecondary Másodlagos fegyverek kikapcsolása
...
social.login.sell Jelentkezz be az eladáshoz
social.login.gift Jelentkezz be az ajándékozáshoz
social.login.proccessing Bejelentkezés...
social.since Ekkortól:
social.user.maps Felhasználó játékai
social.user.mods Felhasználó modjai
social.maps.none Nem találtunk játékokat...
social.mods.none Nem találtunk modokat...
social.market.price.low Legalacsonyabb ár
social.market.price.list Add meg az árat:
social.market.searching Keresés
social.market.listed listázva ennyi ideje: {0}
social.market.list Listázás
social.market.unlist Levétel
social.market.unlisting Levétel...
social.market.posting Listázás...
social.market.req {0}. szint szükséges
social.market.cant Nincs elég KR-ed
social.market.purchase Megvásárlás
social.market.fee Nincs listadíj
social.market.failed Sikertelen. Próbáld  újra
social.market.head Fej
social.market.back Hát
social.market.waist Derék
...
social.market.sort Szűrés/Rendszerezés
social.market.filter Keresés
social.market.sort2 Rendszerezés
social.market.price.high Legmagasabb ár
social.trading.submitting Ajánlat elküldése...
social.market.gift.amount Az ajándék mennyisége ebben:
social.market.fee.gift Díjmentes
...
custom.passcode.input Add meg a szerver jelszavát a belépéshez
custom.tryagain Próbáld újra.
purchase.kr.success {0} KR hozzá lett adva a fiókodhoz
limited.purchase.ask Biztos meg akarod venni ezt: [{0}] {1} KR-ért?
limited.purchase.success {0} KR hozzáadva a a fiókodhoz
pretend.exit Nyomd meg a [{0}] gombot a kilépéshez
settings.loaded Beállítások betöltve
settings.loaded.none Nem találtunk beállításokat
account.login.required Be kell jelentkezned
account.banned.hack Ezt a fiókot bannolták hackelés miatt.
account.banned.appeal Ha fellebbezni szeretnél a ban ellen, vedd fel a kapcsolatot:
account.delete Kérheted a fiókod törlését, ha a kérelmet nem mondod vissza 14 napon belül, a fiókod és az összes vele kapcsolatos adat véglegesen törölve lesz.
account.delete.request Biztosan szeretnéd kérni a fiókod törlését?
account.delete.cancel Biztosan visszamondod a fiókod törlését?
spin.free.available INGYEN KR ELÉRHETŐ!
spin.free.claim Ez a pörgetés óránként elérhető, . Egy meccset le kell játszanod hozzá.
spin.free.disable Ezeket a felugró ablakokat az általános beállításoknál ki lehet kapcsolni.
mod.reset.0 Újraéledés után lép életbe.
mod.reset.1 A tárgyak a pályán nem állítódnak vissza
...
windows.store.wheels.sub Próbálj szerencsét és pörgess hogy nyerj új kinézeteket!
windows.store.currency * Az árak USD-ben vannak megadva és átalakíthatóak a helyi pénz egységbe, a fizetés szolgáltató vagy bank által.
windows.store.creator Fontold meg a kedvenc tartalom készítőd támogatását a Creator Code-ja használatával
windows.chall.customs A kihívásokat nem lehet egyedi meccsekben teljesíteni
twitch.link Biztos hozzá akarod kötni a twitch fiókodat ehhez a krunker fiókhoz?
twitch.unlink Biztos szét akarod kapcsolni a twitch fiókodat a krunker fiókoddal?
windows.clan.leave Biztos ki akarsz lépni a klánból?
