module.exports = `
menu.btn.ranked ශ්‍රේණිගත කර ඇත
menu.btn.shop කඩේ
menu.btn.social හබ්
menu.btn.maps ක්රීඩා
menu.btn.mods මෝඩ්ස්
menu.btn.settings සැකසුම්
menu.btn.customize අභිරුචිකරණය කරන්න
menu.btn.invite ආරාධනා කරන්න
menu.btn.invite.clicked පිටපත් කර ඇත
menu.btn.join එක්වන්න
menu.btn.host සත්කාරක ක්‍රීඩාව
menu.btn.browser සේවාදායකයන්
generic.wait කරුණාකර රැඳී සිටින්න...
generic.loading පූරණය වෙමින්...
generic.none කිසිවක් නැත
generic.connecting සම්බන්ධ වෙමින්...
generic.select තෝරන්න
generic.delete මකන්න
generic.save සුරකින්න
generic.load පැටවීම
generic.search සෙවීම
generic.leave යන්න
generic.default පෙරනිමිය
generic.submit ඉදිරිපත් කරන්න
generic.create නිර්මාණය කරන්න
generic.random අහඹු
generic.failed අසාර්ථකයි
generic.success සාර්ථකත්වය!
generic.name නම
generic.level මට්ටමින්
generic.score ලකුණු
generic.off අක්රියයි
generic.defeat පරාජය කරන්න
generic.victory ජයග්රහණය
generic.matchover තරගය අවසන්
generic.matchaband තරගය අතහැර දමා ඇත
generic.follow අනුගමනය කරන්න
generic.unfollow අනුගමනය නොකරන්න
generic.followers අනුගාමිකයින්
